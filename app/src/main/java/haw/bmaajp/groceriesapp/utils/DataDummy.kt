...
import haw.bmaajp.groceriesapp.ui.theme.BackgroundCategory4
import haw.bmaajp.groceriesapp.ui.theme.BackgroundCategory5
import haw.bmaajp.groceriesapp.ui.theme.BackgroundCategory6
...
object DataDummy {
    ...
    fun generateDummyBrand(): List<BrandItem> {
        return listOf(
            BrandItem(
                id = 1,
                title = "Macaroni",
